...
class HouseHoldData(models.Model):
    ...
    owner_sex = models.CharField(max_length=100, blank=True, null=True)
    owner_status = models.CharField(max_length=100, blank=True, null=True)
    owner_status_other = models.CharField(max_length=100, blank=True, null=True)
    owner_caste = models.CharField(max_length=100, blank=True, null=True)
    owner_caste_other = models.CharField(max_length=100, blank=True, null=True)
    ...
    mother_tongue_other = models.CharField(max_length=100, blank=True, null=True)
    contact_no = models.CharField(max_length=100, blank=True, null=True)
    owner_education = models.CharField(max_length=100, blank=True, null=True)
    owner_citizenship_no = models.CharField(max_length=100, blank=True, null=True)
    responder_name = models.CharField(max_length=100, blank=True, null=True)
    responder_sex = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_family_living = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_business = models.CharField(max_length=100, blank=True, null=True)
    other_small_business = models.CharField(max_length=100, blank=True, null=True)
    crop_sufficiency = models.CharField(max_length=100, blank=True, null=True)
    food_type = models.CharField(max_length=100, blank=True, null=True)
    main_staple = models.CharField(max_length=100, blank=True, null=True)
    pulses = models.CharField(max_length=100, blank=True, null=True)
    vegetables = models.CharField(max_length=100, blank=True, null=True)
    fruits = models.CharField(max_length=100, blank=True, null=True)
    meat_and_fish = models.CharField(max_length=100, blank=True, null=True)
    milk_and_products = models.CharField(max_length=100, blank=True, null=True)
    sugar_products = models.CharField(max_length=100, blank=True, null=True)
    oil_products = models.CharField(max_length=100, blank=True, null=True)
    condiments = models.CharField(max_length=100, blank=True, null=True)
    ...
    loan = models.CharField(max_length=100, blank=True, null=True)
    loan_amount = models.CharField(max_length=100, blank=True, null=True)
    loan_duration = models.CharField(max_length=100, blank=True, null=True)
    animal_presence = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_insurance = models.CharField(max_length=100, blank=True, null=True)
    ...
    vehicles_other = models.CharField(max_length=100, blank=True, null=True)
    facilities_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_facilities = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_fuel_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    house_type_other = models.CharField(max_length=100, blank=True, null=True)
    house_built_year = models.CharField(max_length=100, blank=True, null=True)
    house_stories = models.CharField(max_length=10, blank=True, null=True)
    no_of_rooms = models.CharField(max_length=10, blank=True, null=True)
    house_map_registered = models.CharField(max_length=100, blank=True, null=True)
    building_standard_code = models.CharField(max_length=100, blank=True, null=True)
    earthquake_resistance = models.CharField(max_length=100, blank=True, null=True)
    flood_prone = models.CharField(max_length=100, blank=True, null=True)
    flood_resilience_activities = models.CharField(max_length=100, blank=True, null=True)
    ...
    flood_activities_resilience_other = models.CharField(max_length=100, blank=True, null=True)
    owned_land_area = models.CharField(max_length=100, blank=True, null=True)
    owned_land_near_river = models.CharField(max_length=100, blank=True, null=True)
    owned_land_area_near_river = models.CharField(max_length=100, blank=True, null=True)
    ...
    manpower_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    doctor_sex = models.CharField(max_length=100, blank=True, null=True)
    doctor_male_number = models.CharField(max_length=100, blank=True, null=True)
    doctor_female_number = models.CharField(max_length=100, blank=True, null=True)
    engineer_sex = models.CharField(max_length=100, blank=True, null=True)
    # engineer_sex_male = models.BooleanField(default=False)
    # engineer_sex_female = models.BooleanField(default=False)
    engineer_male_number = models.CharField(max_length=100, blank=True, null=True)
    engineer_female_number = models.CharField(max_length=100, blank=True, null=True)
    subengineer_sex = models.CharField(max_length=100, blank=True, null=True)
    subengineer_male = models.CharField(max_length=100, blank=True, null=True)
    subengineer_female = models.CharField(max_length=100, blank=True, null=True)
    nurse_sex = models.CharField(max_length=100, blank=True, null=True)
    # nurse_sex_male = models.BooleanField(default=False)
    # nurse_sex_female = models.BooleanField(default=False)
    nurse_male_number = models.CharField(max_length=100, blank=True, null=True)
    nurse_female_number = models.CharField(max_length=100, blank=True, null=True)
    ha_lab_sex = models.CharField(max_length=100, blank=True, null=True)
    # ha_lab_sex_male = models.BooleanField(default=False)
    # ha_lab_sex_female = models.BooleanField(default=False)
    ha_lab_male_number = models.CharField(max_length=100, blank=True, null=True)
    ha_lab_female_number = models.CharField(max_length=100, blank=True, null=True)
    veterinary_sex = models.CharField(max_length=100, blank=True, null=True)
    # veterinary_sex_male = models.BooleanField(default=False)
    # veterinary_sex_female = models.BooleanField(default=False)
    veterinary_male_number = models.CharField(max_length=100, blank=True, null=True)
    veterinary_female_number = models.CharField(max_length=100, blank=True, null=True)
    dakarmi_sikarmi_sex = models.CharField(max_length=100, blank=True, null=True)
    # carpenter_sex_male = models.BooleanField(default=False)
    # carpenter_sex_female = models.BooleanField(default=False)
    dakarmi_sikarmi_male_number = models.CharField(max_length=100, blank=True, null=True)
    dakarmi_sikarmi_female_number = models.CharField(max_length=100, blank=True, null=True)
    plumber_sex = models.CharField(max_length=100, blank=True, null=True)
    # plumber_sex_male = models.BooleanField(default=False)
    # plumber_sex_female = models.BooleanField(default=False)
    plumber_male_number = models.CharField(max_length=100, blank=True, null=True)
    plumber_female_number = models.CharField(max_length=100, blank=True, null=True)
    electrician_sex = models.CharField(max_length=100, blank=True, null=True)
    # electrician_sex_male = models.BooleanField(default=False)
    # electrician_sex_female = models.BooleanField(default=False)
    electrician_male_number = models.CharField(max_length=100, blank=True, null=True)
    electrician_female_number = models.CharField(max_length=100, blank=True, null=True)
    jt_sex = models.CharField(max_length=100, blank=True, null=True)
    # jt_or_jta_sex_male = models.BooleanField(default=False)
    # jt_or_jta_sex_female = models.BooleanField(default=False)
    jt_male_number = models.CharField(max_length=100, blank=True, null=True)
    jt_female_number = models.CharField(max_length=100, blank=True, null=True)
    other_technical = models.CharField(max_length=100, blank=True, null=True)
    other_technical_sex = models.CharField(max_length=100, blank=True, null=True)
    # other_sex_male = models.BooleanField(default=False)
    # other_sex_female = models.BooleanField(default=False)
    other_technical_male_number = models.CharField(max_length=100, blank=True, null=True)
    other_technical_female_number = models.CharField(max_length=100, blank=True, null=True)
    ...
    tubewell_type = models.CharField(max_length=100, blank=True, null=True)
    tubewell_status = models.CharField(max_length=100, blank=True, null=True)
    no_of_houses_using_tubewell = models.CharField(max_length=100, blank=True, null=True)
    has_flood_effect_tubewell = models.CharField(max_length=100, blank=True, null=True)
    public_tap_distance = models.CharField(max_length=100, blank=True, null=True)
    toilet_facility = models.CharField(max_length=100, blank=True, null=True)
    ...
    toilet_type_other = models.CharField(max_length=100, blank=True, null=True)
    waterborne_disease = models.CharField(max_length=100, blank=True, null=True)
    ...
    disaster_type_other = models.CharField(max_length=100, blank=True, null=True)
    hazard_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    hazard_type_other = models.CharField(max_length=100, blank=True, null=True)
    is_there_identified_risk_areas = models.CharField(max_length=100, blank=True, null=True)
    disaster_information_medium = models.CharField(max_length=100, blank=True, null=True)
    ...
    disaster_information_medium_other = models.CharField(max_length=100, blank=True, null=True)
    knowledge_on_early_warning_system = models.CharField(max_length=100, blank=True, null=True)
    early_warning_system_installed_nearby = models.CharField(max_length=100, blank=True, null=True)
    got_early_warning_during_disaster = models.CharField(max_length=100, blank=True, null=True)
    got_early_warning_during_through = models.CharField(max_length=100, blank=True, null=True)
    medium_suitable_for_early_warning = models.CharField(max_length=100, blank=True, null=True)
    other_medium_suitable_for_early_warning = models.CharField(max_length=100, blank=True, null=True)
    ...
    evacuation_shelter_availability = models.CharField(max_length=100, blank=True, null=True)
    distance_to_evacuation_shelter = models.CharField(max_length=100, blank=True, null=True)
    capacity_of_evacuation_shelter = models.CharField(max_length=100, blank=True, null=True)
    distance_to_nearest_open_space = models.CharField(max_length=100, blank=True, null=True)
    distance_to_nearest_market = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_goods_available_in_nearest_market = models.CharField(max_length=100, blank=True, null=True)
    distance_to_alternative_market = models.CharField(max_length=100, blank=True, null=True)
    alternative_market_name = models.CharField(max_length=100, blank=True, null=True)
    nearest_market_operation_during_disaster = models.CharField(max_length=100, blank=True, null=True)
    easy_access_to_goods = models.CharField(max_length=100, blank=True, null=True)
    how_goods_were_managed_if_not_available_in_market = models.CharField(max_length=100, blank=True, null=True)
    warehouse_available_in_ward = models.CharField(max_length=100, blank=True, null=True)
    coping_mechanism_during_disaster = models.CharField(max_length=100, blank=True, null=True)
    ...
    other_coping_mechanism_during_disaster = models.CharField(max_length=100, blank=True, null=True)
    emergency_kit_availability_in_house = models.CharField(max_length=100, blank=True, null=True)
    emergency_kit_material_update_frequency = models.CharField(max_length=100, blank=True, null=True)
    involved_disaster_training = models.CharField(max_length=100, blank=True, null=True)
    involved_disaster_training_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    involved_disaster_training_type_other =  models.CharField(max_length=100, blank=True, null=True)
    involved_in_simulation_type = models.CharField(max_length=100, blank=True, null=True)
    ...
    involved_in_simulation_type_other = models.CharField(max_length=100, blank=True, null=True)
    knowledge_about_ldcrp = models.CharField(max_length=100, blank=True, null=True)
    involvement_in_ldcrp_development_process = models.CharField(max_length=100, blank=True, null=True)
    knowledge_about_dprp = models.CharField(max_length=100, blank=True, null=True)
    involvement_in_dprp_development_process = models.CharField(max_length=100, blank=True, null=True)
    prepared_contingency_plan = models.CharField(max_length=100, blank=True, null=True)
    most_occuring_disasters_in_ward = models.CharField(max_length=100, blank=True, null=True)
    ...
    identified_safe_place_for_flood = models.CharField(max_length=100, blank=True, null=True)
    distance_to_safe_place_for_flood = models.CharField(max_length=100, blank=True, null=True)
...
class OwnerFamilyData(models.Model):
    ...
    occupatin = models.CharField(max_length=500, blank=True, null=True)
    ...
    reasons_for_not_received_social_security_ne = models.CharField(max_length=500, blank=True, null=True)
